...
<body>
    <div class="Navbar">
        <div class="container-fluid d-flex justify-content-between">
            <a class="Navbar__brand" href="main.php">
            ...
            <div class="header__menu">
                ...
                <ul>
                    <li><a class="font-weight-bold" href="profile.php">Pokédex</a></li>
                    <li><a class="font-weight-bold" href="main.php">Home</a></li>
    ...
    <div class="ml-5 mr-5 mt-3 Social__title d-flex justify-content-center flex-column">
        <div class="row">
            <div class="col-6 ml-5">
                ...
                <div class="container">
                    <?php foreach ($usersToUse as $i => $user): ?>
                        <form action="trainerView.php" method="post" class="Social__users">
                          <input type="hidden" name="trainer-mail" value="<?= htmlspecialchars($user["correo"]) ?>" />
                          <button type="submit" class="btn btn-link p-0">
                            <li class="BadgesListItem">
                                <img src="../img/avatar.svg" alt="avatar" class="BadgesListItem__avatar" />
                                <div>
                                  <div><span><?= htmlspecialchars($user["nombre"]) ?></span></div>
                                  <div class="font-weight-light"><?= htmlspecialchars($user["correo"]) ?></div>
                                  <div class="font-weight-light"><?= htmlspecialchars($counters[$i]["n"]) ?> Pokémons on his own</div>
                                </div>
                            </li>
                          </button>
                        </form>
